...
public class WeChatUnionIdTokenGranter extends AbstractTokenGranter {
    ...
    protected WeChatUnionIdTokenGranter(AuthorizationServerTokenServices tokenServices, ClientDetailsService clientDetailsService, OAuth2RequestFactory requestFactory, String grantType) {
