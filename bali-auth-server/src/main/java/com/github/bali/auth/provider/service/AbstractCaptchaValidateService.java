 ...
 * @author Petty
 */
public abstract class AbstractCaptchaValidateService implements ICaptchaValidateService {

    private final RedisTemplate<String, String> redisTemplate;

    protected AbstractCaptchaValidateService(RedisTemplate<String, String> redisTemplate) {
