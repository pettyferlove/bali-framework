...
INSERT INTO uc_auth_client_details (id, client_id, resource_ids, client_secret, scope, authorized_grant_types, web_server_redirect_uri, authorities, access_token_validity, refresh_token_validity, additional_information, auto_approve, del_flag, creator, create_time, modifier, modify_time) VALUES ('1347517937222574085', 'bali', NULL, '123456', 'user.read,resource.read', 'password,refresh_token,authorization_code,client_credentials,mobile,wechat', 'http://localhost:9001/login/oauth2/code/bali', NULL, 36000, 36000, NULL, NULL, 0, NULL, '2021-01-08 21:26:13', NULL, '2021-01-08 21:26:18');
