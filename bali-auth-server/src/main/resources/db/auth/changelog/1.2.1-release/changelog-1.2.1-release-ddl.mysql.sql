...
--changeset Petty:uc-1.2.1-release-ddl-2
create index index_0 on uc_user_info (user_id, tenant_id, del_flag);

--changeset Petty:uc-1.2.1-release-ddl-3
create index index_0 on uc_user (user_channel, del_flag);